...
## Available scripts
- [Export Third-Party Vulnerabilities](#export_vulnerabilitiespy)
  - Exports a list of all third party vulnerabilities to a CSV file
- [Export Code-Level Vulnerabilities](#export_cl_vulnpy)
  - Exports a list of all code-level vulnerabilities to a CSV file
- [Export Attacks](#export_attackspy)
  - Exports a list of all attack detections details to a CSV file
...
### [export_cl_vuln.py](export_cl_vuln.py)
exports all code-level vulnerabilites to a CSV file
...
#### Examples
```bash
python3 export_cl_vuln.py -e https://xxxyyyyy.live.dynatrace.com -t dt0c01.XXX... 
```
Additionaly fetch details for each vulnerability
```bash
python3 export_cl_vuln.py -e https://xxxyyyyy.live.dynatrace.com -t dt0c01.XXX... -d
```

### [export_attacks.py](export_attacks.py)
exports all attack detections to a CSV file

Required token scope: Read attacks (`attacks.read`)
...
#### Examples
```bash
python3 export_attacks.py -e https://xxxyyyyy.live.dynatrace.com -t dt0c01.XXX... 
```
Additionaly fetch details for each vulnerability
```bash
python3 export_attacks.py -e https://xxxyyyyy.live.dynatrace.com -t dt0c01.XXX... -d
```
