...
class DynatraceApi:
    ...
    def getAttacks(self):
        ...
        """
        return self.__queryAttacks('/api/v2/attacks?pageSize=500')

    def getAttackDetails(self, attackId):
        """
        gets the details for a specific security problem
        """
        return self.queryApi('/api/v2/attacks/'+attackId+'?fields=%2BattackTarget,%2Brequest, %2Bentrypoint, %2Bvulnerability, %2BsecurityProblem, %2Battacker, %2BmanagementZones')
    

    @lru_cache(maxsize=None)

    def getClvSecurityProblems(self):
        """
        get a list of all security problems from the specified environment
        makes subsequent calls to the API if the results are paged.
        """
        return self.__queryClvSecurityProblems('/api/v2/securityProblems?pageSize=500&securityProblemSelector=vulnerabilityType("CODE_LEVEL")')
    ...
    def __queryAttacks(self, endpoint):
        """
        get a list of all security problems from the specified environment
        makes subsequent calls to the API if the results are paged.
        """
    ...
    @lru_cache(maxsize=None)
    def getClvSecurityProblemDetails(self, securityProblemId):
        """
        gets the details for a specific security problem
        """
        return self.queryApi('/api/v2/securityProblems/'+securityProblemId+'?fields=%2BrelatedEntities,%2BriskAssessment, %2BmanagementZones&securityProblemSelector=vulnerabilityType("CODE_LEVEL")')
